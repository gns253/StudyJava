...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// 2) substring(int beginIndex, int endIndex) : 시작인덱스 부터 끝인덱스-1 까지 추출
		System.out.println("s1.substring(5, 12) : " + s1.substring(5, 12));
		// => 5번 인덱스 부터 12-1 (11번) 인덱스 까지 추출되므로 Program 추출됨
		...
		// 따라서, "." 기호 대신 "\\." 기호를 사용해야만 문장 단위 불리가 가능함
		...
		// => System.out.printf() 메서드 역할과 동일하나 출력을 위한 것이 아리나
