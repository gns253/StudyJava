...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *      전달하여 객체 형태로 포장하는 기능
		 *   => 컴파일러에 의해 자동으로 변환(포장)된어진다!   
		 * 2. 오토 언박싱 (Auto Unboxing)
		 * - Wrapper 클래스타입 객체(박스)의 포장을 뜯어서 기본데이터타입(물건) 꺼내기
		 *   => Heap 공간의 객체 박스(Wrapper클래스타입)에 들어있는 물건(기본 데이터타입 값)을
		 *      꺼내서 기본 데이터타입으로 변환
...
//		System.out.println("참조데이터타입 n1 = " + n1);
		...
		n1 = num1; // 오토박싱
		System.out.println("기본데이터타입 num1 = " + num1);
		System.out.println("참조데이터타입 n1 = " + n1); // n1.toString() 생략되어 있고 
...
//		System.out.println("참조데이터타입 n2 = " + n2);
		...
		// 2. Java(JDK 1.5) 부터 사용가능한 방법
		//    => 기본데이터타입변수 = Wrapper클래스타입변수;
		//       => 오토 언박싱 기능에 의해 참조데이터타입 -> 기본데이터타입 변환되어 저장
		num2 = n2;
		System.out.println("기본데이터타입 num2 = " + num2);
		System.out.println("참조데이터타입 n2 = " + n2);
